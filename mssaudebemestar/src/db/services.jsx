...
const services = [
    {
        ...
        name:"Osteopatia ",
        description:`A osteopatia é uma prática terapêutica manual que busca diagnosticar, tratar e prevenir disfunções no corpo, promovendo o equilíbrio estrutural e funcional para melhorar a saúde geral. Ela utiliza técnicas específicas para estimular o sistema musculoesquelético, nervoso e visceral, ajudando a aliviar dores, restaurar a mobilidade e otimizar o funcionamento do organismo, respeitando sua capacidade natural de autocura.`,
        professionals:[1,2,3],
        subService:null
    }, 
    {
    ...
    },
    {
        ...
        description:"A drenagem linfática é uma técnica de massagem manual que estimula o sistema linfático, promovendo a eliminação de líquidos e toxinas do organismo. Por meio de movimentos suaves, rítmicos e direcionados, ela auxilia na redução de inchaços, melhora a circulação, fortalece o sistema imunológico e contribui para o relaxamento e o bem-estar geral.",
        professionals:[1],
        subService:null
    },
    {
        ...
        description:"A drenagem linfática pós-cirúrgica é uma técnica especializada que auxilia no processo de recuperação após procedimentos cirúrgicos, reduzindo edemas, hematomas e desconfortos causados pelo acúmulo de líquidos. Com movimentos leves e direcionados, estimula o sistema linfático, favorecendo a cicatrização, aliviando inflamações e acelerando a regeneração dos tecidos, contribuindo para uma recuperação mais rápida e eficaz.",
        professionals:[1],
        subService:null
    },
    {
